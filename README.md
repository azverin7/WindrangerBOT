...
Настройте переменные окружения: Создайте файл `.env` в корневой директории:
...
Инициализация инфраструктуры сервера: После добавления бота на сервер, Владелец сервера или Разработчик должен выполнить:
